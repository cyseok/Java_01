...
public class UserinfoModelOneDAO extends JdbcDAO {
	...
	//======================================================================================
	// 회원정보를 전달받아 userinfo 테이블에 회원정보를 삽입하고 삽입행의 개수 반환
	public int insertUserinfo(UserinfoDTO userinfo) {
		...
		try {
			...
			System.out.println("[에러]insertUserinfo() 메서드의 SQL 오류 = "+e.getMessage());
		} finally {
			close(con, pstmt);
		}
		return rows;
	...
	//======================================================================================
	// 회원정보를 전달받아 userinfo 테이블에 회원정보를 변경하고 변경행의 개수 반환
	...
	//======================================================================================
	// 회원정보를 전달받아 userinfo 테이블에 회원정보를 삭제하고 삭제행의 개수 반환
	...
	//======================================================================================
	// 회원정보를 전달받아 userinfo 테이블에 회원정보를 검색해 DTO 객체로 반환
	...
	//======================================================================================
	//  userinfo 테이블의 모든 회원정보를 검색하고 List 객체로 반환
