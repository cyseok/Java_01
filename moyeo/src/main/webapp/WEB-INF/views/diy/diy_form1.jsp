					...
					<div class="map_spot">
						...
						<div class="map_spot_right">
							<table>
								<tr>
									<td>
										<input type="radio" name="chk_info" value="1day">
									</td>
									<td>
										1일차
									</td>
									<td>
										<input type="text" placeholder="ex)부산역 > 자갈치 > 광안리 > 해운대" name="diy_content1" value="${diyContent1}">
									</td>
								</tr>
								<tr>
									<td><input type="radio" name="chk_info" value="2day"></td>
									<td>2일차</td>
									<td><input type="text" placeholder="ex)부산역 > 사직 > 남포동" name="diy_content1" value="${diyContent2}"></td>
								</tr>
								<tr>
									<td><input type="radio" name="chk_info" value="3day"></td>
									<td>3일차</td>
									<td><input type="text" placeholder="ex)부산역 > 사직 > 남포동" name="diy_content3" value="${diyContent3}"></td>
								</tr>
							</table>
