...
public class UserGUIApp extends JFrame implements ActionListener {
	...
	public void displayAllUser() {
		List<UserDTO> userList = UserImpl.getDao().selectAllUserList();
	...
	public void addUser() {
		...
		if(UserImpl.getDao().selectUser(USER_NO) != null) {
...
//		}
		...
		int rows=UserImpl.getDao().insertUser(user);
	...
	public void removeUser() {
		...
		//DAO 클래스의 메소드 호출
		int rows=UserImpl.getDao().deleteUser(no);
	...
	public void searchNameUSer() {
		...
		//하는 DAO 클래스의 메소드 호출
		List<UserDTO> userList =UserImpl.getDao().selectNameUserList(USER_NAME);
