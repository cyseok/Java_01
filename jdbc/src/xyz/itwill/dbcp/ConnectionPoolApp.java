...
// => Connection 객체를 생성하기 위한 정보릐 변경 용이 -> 유지보수 효율성 증가
...
public class ConnectionPoolApp {
	...
	public static void main(String[] args) throws SQLException {
		...
		// ConnectionPool 클래스는 싱글톤 클래스이므로 new 연산자를 사용하여 
		//  객체를 생성하지 않고 객체를 반환받아 사용
		// => ConnectionPool 객체에는 Connection 객체가 2개 저장되어 있다.
		ConnectionPool cp = ConnectionPool.getInstance();
		
		// ConnectionPool.getConnection() : ConnectionPool 객체에 저장된 Connection객체 중
		//  하나를 반환하는 메소드
