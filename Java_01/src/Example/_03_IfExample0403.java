...
public class _03_IfExample0403 {
	public static void main(String[] args) {
		...
		/*
		 * if((kor > 100 || kor < 0) || (eng > 100 || eng < 0) || (mat < 100 || mat <
		 * 0)) { System.out.println("[에러]0~100 범위를 벗어난 비정상적인 점수가 입력 되었습니다.");
		 * System.exit(0); }
		 */
		...
		if (vaild)
			System.exit(0);// 검증이 실행한 경우 프로그램 종료
