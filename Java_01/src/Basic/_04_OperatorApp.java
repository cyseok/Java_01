...
public class _04_OperatorApp {
	public static void main(String[] args) {
		...
		int a4 = 10, a5 = 10;
		System.out.println(a4 + a5); // 20

		int result1 = ++a4;
		int result2 = a5++;
		System.out.println(a4 + a5); // 22 바로 호출되기때문에 11 + 11
		System.out.println(result1 + result2); // 21 -> 11 + 10 ...a5 = 11
		...
		int c = 20;
		System.out.println(c >= 20 && !(c <= 10));
		System.out.println(c >= 20 || (c <= 40));
		System.out.println(c >= 20 ^ (c <= 40));

		// 삼항연산자
		int score = 85;
		String result = (score >= 85) ? "A" : "B";
		System.out.println(result);

		int d1 = 17;
		System.out.println(d1 + " = " + (d1 % 2 == 0 ? "짝수" : "홀수")); */
