<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%-- AJAX 기능을 이용하여 [xml_two.jsp] 문서를 요청하여 태그를 변경해 클라이언트에게 전달하여 응답하는 문서
=> XML 형식의 데이터를 제공받아 HTML 태그로 변환하여 페이지 변경 -> 파싱(parsing) 처리
=> XML(eXtensible Markup Language) : 엘리먼트(태그)를 사용하여 값을 구분하여 제공하는 구조적인 데이터 --%>
