...
<%
	...
	// 사용자로부터 입력받아 전달된 값에 태그관련 문자값이 존재할 경우 문제 발생
	// => XSS(Cross Site Script) 공격 : 사용자로부터 악의적인 스크립트를 입력받아 페이지의 이상이 생기거나
	//		다른 사용자의 사용방해 또는 쿠키 및 기다 개인 정보를 특정 사이트로 전송하는 공격방법
