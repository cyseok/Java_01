...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%-- 클라이언트가 JSP 문서를 요청하면 WAS 프로그램은 JSP 문서를 해석하여 Servlet 클래스를 생성하고
컴파일하여 객체를 생성한 후 요청처리 메소드를 호출해 클라이언트 요청에 대한 처리와 실행결과 저장 파일을
생성하여 클라이언트에게 전달해 응답함 
...
<body>
	...
	<p>JSP(Java Server Page) : 서블릿보다 쉽게 웹프로그램을 작성하기 위한 기술<br>
