...
<body>
	...
	<hr>
	<p>page Directive의 contentType 속성에는 JSP 문서를 요청하여 응답 받을 수 있는 파일 형태(MimeType)와
	 ...
	 <table>
	    ...
	    <tr>
	 		<td>1000</td><td>홍길동</td><td>서울</td>
	 	</tr>
	 	<tr>
	 		<td>2000</td><td>임꺽정</td><td>경기</td>
	 	</tr>
	 	
	 	<tr>
	 		<td>3000</td><td>전우치</td><td>인천</td>
	 	</tr>
