...
<%
	...
	// STUDENT 테이블에 저장된 학생정보를 검색해 DTO 객체로 반환하는 DAO 메소드
	StudentDTO student = StudentDAO.getDAO().selectStudent(no);
	
	// STUDENT 테이블에 저장된 학생정보를 검색하지 못한 경우 -> 비정상적 요청
	if(student==null) {
...
<body>
	...
	=> 학생번호는 변경하지 못하도록 hidden type으로 전달하거나 
		입력태그의 초기값을 변경하지 못하도록 readonly 속성을 사용할 수도 있다. --%>
	...
	<table align="center" border="1" cellpadding="1" cellspacing="0" width="300">
		<tr height="40">
			...
			<td width="200" align="center">
				...
				<%-- <%=student.getNo() %> --%>
				<%-- 위 표기 대신에 바로 아래처럼 readonly를 사용할 수도 있다.  --%>
				<input type="hidden" name="no" value="<%=student.getNo() %>" readonly="readonly">
			</td>
		</tr>
		<tr height="40">
		...
		<tr height="40">
			...
			<td width="200" align="center">
				<input type="text" name="address" value="<%=student.getAddress()() %> 강남구">
			</td>
		</tr>
		<tr height="40">
