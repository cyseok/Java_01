...
public class LoginController {
	...
	/* 개별적으로 불러오는 방법(아이디,비밀번호)
	//전달값을 제공받아 인증 처리 후 권한 관련 정보를 Session Scope 속성값으로 저장하고 
	//  로그인 성공 메세지를 출력하는 JSP 문서의 뷰이름을 반환하는 요청처리 메소드
	// => 전달값을 String 매개변수에 하나씩 제공받아 사용
