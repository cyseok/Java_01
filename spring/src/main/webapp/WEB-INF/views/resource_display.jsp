...
<body>
	...
	<%-- 문제점) SpringMvc 프로그램에서는 클라이언트의 모든 요청을 Front Controller를 이용하여 처리되도록 url-pattern 설정 --%>
	<%-- 클라이언트가 서버의 리소스 파일을 요청할 경우 Front Controller가 요청을 받아 
	...
	<%-- <img src="spring/puppy.jpg" width="200"> --%>
	<%-- =============================================================================                                                                                                          --%>
	<%-- 컨텍스트 이름이 변경될 경우 컨텍스트 경로가 변경되어 404 에러 코드 발생 --%>
	<%-- → 컨텍스트 경로는 직접 지정하지 않고 객체로 제공받아 사용 --%>
	<img src="/spring/resources/images/puppy.jpg" width="200"><%-- 절대경로로 적용 --%>
	<%-- 컨텍스트 경로를 EL의 pageContext 내장객체로 제공받아 사용 --%>
	<img src="${pageContext.request.contextPath }/images/puppy.jpg" width="200"><%-- 컨텍스트 경로로 적용 --%>
	<%-- 컨텍스트 경로를 Core 태그 라이브러리의 URL 태그로 제공받아 사용 --%>
	<img src="<c:url value="/images/puppy.jpg"/>" width="200"><%-- 코어 태그 라이브러리 적용 --%>
	<%-- 컨텍스트 경로를 Spring 태그 라이브러리의 URL 태그로 제공받아 사용 --%>
	<img src="<spring:url value="/images/puppy.jpg"/>" width="200"><%-- 코어 태그 라이브러리 적용 --%>
</body>
</html>